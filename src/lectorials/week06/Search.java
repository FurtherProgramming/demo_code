...
public class Search {
	public static void main(String[] args) {
		...
		for(int count=(int) 1e5; count<1e9; count = count*10) {
			...
			System.out.println(al.contains(Integer.valueOf(-1)));
			long endTime = System.currentTimeMillis();
			long duration = (endTime - startTime);
			System.out.println("ArrayList with " + count + " elements" + " Running time: " + duration + " milliseconds");
		}
		System.out.println();
		...
		for(int count=(int) 1e5; count<1e8; count = count*10) {
			...
			long startTime = System.currentTimeMillis();
			System.out.println(ll.contains(Integer.valueOf(-1)));
			long endTime = System.currentTimeMillis();
			long duration = (endTime - startTime);
